...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('action_type', mysql.ENUM('composite', 'department', 'member', 'bonus', charset='utf8mb4', collation='utf8mb4_0900_ai_ci'), nullable=False),
        sa.Column('ar_action_name', mysql.VARCHAR(100, charset='utf8mb4', collation='utf8mb4_0900_ai_ci'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('location_type', mysql.ENUM('online', 'on-site', 'none', 'hidden', charset='utf8mb4', collation='utf8mb4_0900_ai_ci'), nullable=False),
        ...
        sa.Column('status', mysql.ENUM('draft', 'open', 'active', 'closed', charset='utf8mb4', collation='utf8mb4_0900_ai_ci'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('google_form_id', mysql.VARCHAR(100, charset='utf8mb4', collation='utf8mb4_0900_ai_ci'), nullable=True),
        sa.Column('google_refresh_token', mysql.VARCHAR(500, charset='utf8mb4', collation='utf8mb4_0900_ai_ci'), nullable=True),
        sa.Column('form_type', mysql.ENUM('none', 'registration', 'google', charset='utf8mb4', collation='utf8mb4_0900_ai_ci'), nullable=False),
        sa.Column('google_watch_id', sa.String(100), nullable=True),
        sa.Column('google_responders_url', mysql.VARCHAR(150, charset='utf8mb4', collation='utf8mb4_0900_ai_ci'), nullable=True),
        sa.PrimaryKeyConstraint('id'),
        sa.ForeignKeyConstraint(['event_id'], ['events.id'], name='forms_ibfk_1', ondelete='CASCADE', onupdate='CASCADE'),
    )
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint('id'),
        sa.ForeignKeyConstraint(['action_id'], ['actions.id'], name='logs_ibfk_1', ondelete='CASCADE', onupdate='CASCADE'),
    ...
    op.create_table(
        ...
        sa.Column('role', mysql.ENUM('admin', 'super_admin', 'admin_points', 'none', charset='utf8mb4', collation='utf8mb4_0900_ai_ci'), nullable=False),
        sa.PrimaryKeyConstraint('id'),
        sa.ForeignKeyConstraint(['member_id'], ['members.id'], name='fk_role_member', ondelete='CASCADE', onupdate='CASCADE'),
    )
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint('id'),
        sa.ForeignKeyConstraint(['department_id'], ['departments.id'], name='departments_logs_departments_FK', ondelete='CASCADE', onupdate='CASCADE'),
        sa.ForeignKeyConstraint(['log_id'], ['logs.id'], name='departments_logs_logs_FK', ondelete='CASCADE', onupdate='CASCADE'),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['log_id'], ['logs.id'], name='members_logs_logs_FK', ondelete='CASCADE', onupdate='CASCADE'),
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint('id'),
        sa.ForeignKeyConstraint(['log_id'], ['logs.id'], name='modifications_ibfk_1', ondelete='CASCADE', onupdate='CASCADE'),
    )
    ...
    op.create_table(
        ...
        sa.Column('submission_type', mysql.ENUM('none', 'registration', 'partial', 'google', charset='utf8mb4', collation='utf8mb4_0900_ai_ci'), nullable=False),
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('member_id', 'form_id', name='submissions_unique'),
        sa.ForeignKeyConstraint(['form_id'], ['forms.id'], name='submissions_ibfk_1', ondelete='CASCADE', onupdate='CASCADE'),
        sa.ForeignKeyConstraint(['member_id'], ['members.id'], name='submissions_ibfk_2', ondelete='CASCADE', onupdate='CASCADE'),
    )
