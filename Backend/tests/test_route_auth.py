...
EXPECTED_AUTH: dict[str, str | None] = {
    ...
    "GET /emails/jobs": "admin_guard",
    "GET /emails/jobs/unfinished": "admin_guard",
    "GET /emails/jobs/{job_id:int}": "admin_guard",
    ...
    "GET /events/paginated": "admin_guard",
    ...
    "GET /members/paginated": "admin_guard",
    "GET /members/roles": "super_admin_guard",
    "GET /members/stats": "admin_guard",
