...
@router.get("/{event_id}", status_code=status.HTTP_200_OK, response_model=Events_model)
...
@router.post("/", status_code=status.HTTP_201_CREATED, response_model=Events_model)
...
@router.put("/{event_id}", status_code=status.HTTP_200_OK, response_model=Events_model)
