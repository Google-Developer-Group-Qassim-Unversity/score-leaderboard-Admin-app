...
def get_all_members(session: SessionDep, credentials: Annotated[HTTPAuthorizationCredentials, Depends(admin_guard)]):
...
def get_member_by_uni_id(
    uni_id: str, session: SessionDep, credentials: Annotated[HTTPAuthorizationCredentials, Depends(admin_guard)]
):
    member = member_queries.get_member_by_uni_id(session, uni_id)
    return member
...
def get_member_by_id(
    member_id: int, session: SessionDep, credentials: Annotated[HTTPAuthorizationCredentials, Depends(admin_guard)]
):
...
def get_member_roles(
    session: SessionDep, credentials: Annotated[HTTPAuthorizationCredentials, Depends(super_admin_guard)]
):
