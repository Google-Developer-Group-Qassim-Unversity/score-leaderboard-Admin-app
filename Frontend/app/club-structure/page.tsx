...
import { ClubLoading, ClubRefresh, QueryError } from "@/components/club-structure/shared";
            ...
            <div className="flex flex-wrap items-center gap-3">
              <div className="flex gap-1 rounded-xl border bg-card p-1" role="group" aria-label={t("departmentStatus")}>
                {(["active", "archived"] as const).map((value) => (
                  ...
                  >
                    {t("statusCount", { status: t(value), count: value === "active" ? activeCount : archivedCount })}
                  </Button>
                ))}
              </div>
